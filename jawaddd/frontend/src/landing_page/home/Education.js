    ...
    return (  
        <div className='Container p-5'>            
            ...
            <div className='col-6 p-2'>
                    ...
                    <a href=''className="mx-1 ml-5"style={{textDecoration:"None"}}>Varsity <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
                    ...
                    <a href=''className="mx-1 ml-5"style={{textDecoration:"None"}}>TradingQ&A <i class="fa fa-angle-double-right" aria-hidden="true"></i></a>
